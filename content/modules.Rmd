...
The best way to use this is to download the package and run it locally. This ensures that the modules work quickly for you. To do this you need to install a few packages (if you don't already have them on your computer):
...
learnr::run_tutorial("r_marky_markdown_and_the_funky_docs", package = "DoSStoolkit")
